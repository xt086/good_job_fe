...
const Lan: React.FC = () => {
  return (
    <section className="max-w-[1440px] flex flex-col gap-[100px] mx-auto px-4 py-10 w-full ">
          ...
          <div className="w-full md:w-1/2">
            <div className="flex flex-col text-left gap-7">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-yellow-200">+6 triệu</h2>
                <p className="text-2xl">Nhân tài khắp Đông Nam Á</p>
              </div>
              <hr className="border-t-2 border-yellow-500"></hr>
              <div className="text-center">
                <h2 className="text-3xl font-bold text-yellow-200">+60,000</h2>
