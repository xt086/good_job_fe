        ...
        <div className="mb-10 border rounded-lg shadow-md md:p-10 p-4">
          ...
          <div className="md:max-w-[70%]">
            ...
            <p className="md:text-xl text-[18px]  mb-4">
              Tọa lạc tại trung tâm quận Hoàn Kiếm - nơi lịch sử và văn hóa của
              Hà Nội hòa quyện cùng nhịp sống hiện đại, Khách sạn Authentic
              Hanoi Boutique là điểm đến lý tưởng cho du khách muốn trải nghiệm
              sự thanh lịch, tinh tế và đầy ấn tượng.{" "}
            </p>
            <h4 className="text-2xl font-semibold mb-4 border-b-2 border-gray-500">
